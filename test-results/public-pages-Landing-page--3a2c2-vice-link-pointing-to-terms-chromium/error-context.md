...
- Name: public-pages.spec.ts >> Landing page >> footer contains a Terms of Service link pointing to /terms
- Location: e2e/public-pages.spec.ts:18:7
...
Locator: locator('footer a[href="/terms"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('footer a[href="/terms"]')
