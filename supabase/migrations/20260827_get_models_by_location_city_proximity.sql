-- =============================================================================
-- get_models_by_location: optional p_city proximity OR (parity with discovery)
--
-- Same additive rule as get_discovery_models (20260826): when p_city is set
-- and p_search_lat / p_search_lng are provided, include models within
-- p_city_radius_km of the search point using the winning model_locations row.
-- =============================================================================
...
COMMENT ON FUNCTION public.get_models_by_location(
  ...
  'Location-based model list. 20260827: p_search_lat/lng + p_city_radius_km optional '
  'proximity OR with p_city (parity with get_discovery_models).';
...
BEGIN
  ...
  ), 'get_models_by_location missing after 20260827 migration';
END;
$$;
