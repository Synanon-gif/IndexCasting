-- Block using agency_update_model_full to set agency_relationship_status = 'ended'.
-- Ending representation must go through agency_remove_model (MAT + models row, idempotent).
