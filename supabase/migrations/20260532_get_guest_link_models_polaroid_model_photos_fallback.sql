-- =============================================================================
-- Polaroid packages: fill polaroids from model_photos when models.polaroids
-- mirror is empty/stale (parity with get_discovery_models portfolio fallback,
-- §27.1 model_photos as source of truth for visible media).
-- =============================================================================
...
BEGIN
  ...
  ), 'FAIL: get_guest_link_models missing after 20260532 migration';
END $$;
