-- =============================================================================
-- Dashboard unread parity with Messages workspace (B2B + agency-model direct).
-- Excludes: non-direct threads, unrelated orgs, terminal booking-card messages.
-- Adds SET row_security TO off (SECDEF reads tenant tables).
-- =============================================================================
...
BEGIN
  ...
  -- Unread = distinct visible workspace conversations (matches Messages lists).
