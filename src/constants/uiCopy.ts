...
export const uiCopy = {
  ...
  /** Client–agency connection requests and shared messenger threads (same conversation_id on both sides). */
  connections: {
    messagesIntro:
      'Option requests, client connection requests, and recruiting chats — all in one place.',
    tabOptionRequests: 'Option requests',
    tabRecruiting: 'Recruiting chats',
    tabClientRequests: 'Client requests',
    tabConnectionChats: 'Connection chats',
    tabAgencyRequests: 'Agency requests',
    tabRecruitingChats: 'Recruiting chats',
    noAgencyRequests: 'No agency connection requests yet.',
    ...
    clientsSectionSubtitle: 'Search client accounts and send a connection request.',
    ...
    noAgencyContext: 'No agency context — cannot load requests.',
    noIncomingRequests: 'No incoming requests yet',
    pendingRequestsHeading: 'Pending',
    activeConnectionChatsHeading: 'Connection chats',
    noConnectionChatsYet:
      'No agency connection chats yet. Send a request from Agencies and wait for the agency to accept.',
    ...
    signInToAcceptBody: 'Please sign in to accept.',
    connectedTitle: 'Connected',
    connectedBody:
      'You can chat below. The client sees the same thread under Messages → Connection chats.',
    acceptFailed: 'Could not accept the request. Check permissions (RLS) or try again.',
    /** Client web — Agencies tab */
    agenciesSectionTitle: 'Agencies',
    agenciesSubtitle: 'Search and connect with agencies',
    ...
    signInToSendRequestBody: 'Please sign in as a client to send a connection request.',
    signInToSendRequestGeneric: 'Please sign in to send a connection request.',
    requestFailedTitle: 'Request failed',
    duplicateConnection: 'You already have a pending or existing connection with this agency.',
    requestFailedGeneric: 'Could not send the request. Check your network and try again.',
    couldNotAcceptRequest: 'Could not accept the request.',
    contactLink: 'Contact',
  },
} as const;
